...
const ACTIONS = [
  ...
  { key: "THREAD_CREATED", label: "Start a grow talk", icon: MessageSquare, points: REP_POINTS.THREAD_CREATED },
  { key: "POST_CREATED", label: "Drop a reply", icon: MessageCircle, points: REP_POINTS.POST_CREATED },
  { key: "DIARY_CREATED", label: "Start a grow diary", icon: BookOpen, points: REP_POINTS.DIARY_CREATED },
  { key: "DIARY_UPDATE", label: "Log a diary update", icon: Repeat, points: REP_POINTS.DIARY_UPDATE },
  { key: "STRAIN_CREATED", label: "Add a strain", icon: Dna, points: REP_POINTS.STRAIN_CREATED },
  { key: "STRAIN_PHOTO", label: "Post a bud shot", icon: Camera, points: REP_POINTS.STRAIN_PHOTO },
  { key: "LIKE_RECEIVED", label: "Get a nod", icon: Heart, points: REP_POINTS.LIKE_RECEIVED },
