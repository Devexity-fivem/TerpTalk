    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6 text-sm text-muted-foreground leading-relaxed break-words">
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">1. You must be 21 or older</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">2. No buying, selling, or sourcing — ever</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">3. Treat people well</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">4. Keep the platform clean and safe</h2>
            <ul className="list-disc list-inside space-y-1.5">
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">5. Only post content you have rights to</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">6. When rules are broken</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">7. How to report a problem</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">8. Think a decision was wrong?</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">9. TerpBot isn&apos;t a moderator</h2>
