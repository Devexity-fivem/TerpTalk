    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6 text-sm text-muted-foreground leading-relaxed break-words">
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">Services we rely on</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">How long we keep things</h2>
            <ul className="list-disc list-inside space-y-1.5">
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">How we protect your data</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">Changes &amp; questions</h2>
