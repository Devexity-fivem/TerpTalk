    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6 text-sm text-muted-foreground leading-relaxed break-words">
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">1. Who can join</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">2. The number-one rule: no buying or selling</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">3. Community rules</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">8. Deals and external links</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">9. The service itself</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-2">10. Changes to these terms</h2>
