...
export const BADGE_DESCRIPTIONS: Record<string, string> = {
  ...
  "Top Contributor": "Reached 10,000 reputation points.",
  ...
  "Sprout": "Reached 250 reputation.",
  "Seedling": "Reached 750 reputation.",
  "Grower": "Reached 1,500 reputation.",
  "Cultivator": "Reached 3,500 reputation.",
  "Master Grower": "Reached 7,000 reputation.",
  "Legendary Grower": "Reached 15,000 reputation.",
}
