...
const DATA_URI = /^data:image\/(png|webp|jpe?g);base64,(.+)$/
...
// PNG, WebP, and JPEG are accepted. JPEG is re-encoded to WebP server-side
// to strip EXIF/GPS/XMP metadata before it reaches Vercel Blob.
